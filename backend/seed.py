...
DEMO_ACCOUNTS: dict[str, dict] = {
    "ram":       {"name": "Ram Sharma", "email": "ram@mankosathi.app", "role": "user", "bio": "Feeling stretched between work stress and missing family, but trying to stay grounded one day at a time.", "health_status": "anxiety, stress"},
    "ananya":    {"name": "Ananya Thapa", "email": "ananya@mankosathi.app", "role": "user", "bio": "Meditation, small routines, and honest conversations have been helping me lately.", "health_status": "depression, burnout"},
    "sita":      {"name": "Sita Gurung", "email": "sita@mankosathi.app", "role": "user", "bio": "Sleep has been difficult, but I am here to meet kind people who understand the hard days too.", "health_status": "insomnia, anxiety"},
    "dr-sharma": {"name": "Dr. Sharma", "email": "dr.sharma@mankosathi.app", "role": "therapist", "bio": "Therapist focused on helping people feel heard, steady, and supported through anxiety and life transitions.", "health_status": "caregiver support"},
    "dr-patel":  {"name": "Dr. Patel", "email": "dr.patel@mankosathi.app", "role": "therapist", "bio": "Interested in culturally aware care, stress management, and practical tools people can use every day.", "health_status": "stress management"},
    "admin":     {"name": "Admin", "email": "admin@mankosathi.app", "role": "admin", "bio": "Helping keep the MankoSathi community safe, respectful, and available when people need support.", "health_status": "community support"},
}
